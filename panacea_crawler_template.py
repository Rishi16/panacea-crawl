...
class Crawler(spider):
    ...
    def __init__(self, current_path, object=None):
        ...
        super().cache()
        general.header_values(["category_path", "category_url", "product_url_mod", "product_url", "page_url", "deal_type"])

    # Crawler begins here. input_row list will contain a single tab separated input from the input_file
